...
func (repo *DynamoDBRepository) CreateFile(ctx context.Context, f *boneless.File) (location string, err error) {
...
func (repo *DynamoDBRepository) CreateUploadUrl(ctx context.Context, request boneless.FileUploadRequest) (response boneless.FileUploadResponse, err error) {
